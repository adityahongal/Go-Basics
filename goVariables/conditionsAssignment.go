...
// First, set finalCost to the bulkMessageCost.

// If the user is premium, then the discountRate should be applied to the finalCost.
// A discountRate of 0.20 means the discounted price per message would be 80% of the original price.
